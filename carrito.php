...
<header>
    ...
    <div class="contenedor">
        <div class="menu">
            ...
            <a class="carrito" href="#"onclick="vercarrito()"><img src="imagenes/carrito.png" width="40" height="40"  title="ir al carrito de compras"></a>
        ...
        <div class="cuerpo">
           <div class="libros">
               ...
               <br>
                <a class="agregar_carrito" href="#"onclick="agregarcarrito('1');"><img src="imagenes/carrito.png" width="30" height="30">Agregar al carrito</a>
                </div>
                <div class="libros_abajo">
                       <h3 align="center">Node js</h3>
                        ...
                        <br>
                        <a class="agregar_carrito" href="#" onclick="agregarcarrito('2');"><img src="imagenes/carrito.png" width="30" height="30">Agregar al carrito</a>
                </div>
           ...
           <div class="libros1">
                ...
                <a class="agregar_carrito" href="#"onclick="agregarcarrito('3');"><img src="imagenes/carrito.png" width="30" height="30">Agregar al carrito</a>
                </div>
                <div class="libros_abajo">
                        ...
                        <a class="agregar_carrito" href="#"onclick="agregarcarrito('4');"><img src="imagenes/carrito.png" width="30" height="30">Agregar al carrito</a>
           ...
           <div class="libros2">
                ...
                <a class="agregar_carrito" href="#"onclick="agregarcarrito('5');"><img src="imagenes/carrito.png" width="30" height="30">Agregar al carrito</a>
                ...
                <div class="libros_abajo">
                        ...
                        <a class="agregar_carrito" href="#"onclick="agregarcarrito('6');"><img src="imagenes/carrito.png" width="30" height="30">Agregar al carrito</a>
